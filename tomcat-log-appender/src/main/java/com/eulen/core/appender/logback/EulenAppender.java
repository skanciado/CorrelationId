...
package com.eulen.core.appender.logback;
...
import com.eulen.core.EulenRequestIdGlobalFilter;
...
public class EulenAppender<E> extends OutputStreamAppender<E> {
	...
	protected void append(E eventObject) {
		try {
			MDC.put("X-Correlation-Id", EulenRequestIdGlobalFilter.getCorrelationId());
		} catch (Exception e) {
			MDC.put("X-Correlation-Id", null);
		}
		// EulenRequestIdGlobalFilter.getCorrelationId());
